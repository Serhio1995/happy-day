<?php get_header(); ?>
<div class="blog-page">
  <section class="blog-hero"><div class="hd-wrap blog-hero-inner"><span class="blog-kicker">Ideas, details &amp; inspiration</span><h1>Stories Worth Celebrating.</h1><p>Practical planning advice, balloon decor ideas, colour inspiration, and thoughtful details for events across Toronto and the GTA.</p></div></section>
