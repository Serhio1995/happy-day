    ...
    <?php if($is_shop_view): ?>
      ...
      <section class="hd-shop-faq" aria-labelledby="hd-shop-faq-title">
        ...
        <div class="faq-list">
          ...
          <details><summary>What quality of balloons are used in your shop products?</summary><p>Every product is styled with premium latex balloons, mostly Italian-made, sourced through trusted Canadian suppliers rather than the cheapest imported balloons. This keeps the colours shown on the product page accurate and the finished piece holding its shape for your event, rather than arriving underfilled or fading quickly. It is the same material standard used across our custom, on-location installations, applied consistently to every online order.</p></details>
        </div>
      </section>
    <?php endif; ?>
  </div></section>
